...
<head>
    ...
    <title>{{ config('app.name', 'Blog Sanders') }}</title>
...
<body>
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link {{ activeMenu('/') }}" href="{{ route('inicio') }}">Inicio</a>
                            </li>
        ...
        <footer class="navbar-expand-md navbar-light navbar-laravel">
            <p class="container">Copyright &copy; {{ date('Y') }}</p>
        </footer>
    </div>
</body>
</html>
